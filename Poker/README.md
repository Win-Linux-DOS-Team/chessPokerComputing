...
1) 为便于检查配对，花括号统一遵循 Allman 风格中花括号的风格，即，将左大括号置于新行并与函数签名或控制语句对齐，右大括号独占一行并与函数签名或控制语句对齐；当 lambda 函数的函数体跨行表述时，涵盖 lambda 函数体的左花括号写于行末，遵循 K & R 风格中的花括号风格而不遵循 Allman 风格中的花括号风格。
